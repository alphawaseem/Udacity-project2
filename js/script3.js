...
// I have created to Timer class to manage the timer functionality in a single place.
class Timer {
	constructor() {
		this.reset();
	}
	...
	getSecondsElapsed() {
		// Subtracting the startTime and with endTime will give us the time elapsed in ms,
		// then I divided it by 1000 to get in seconds
		return parseInt(((this.endTime || Date.now()) - (this.startTime || Date.now() )) / 1000);
	}

	getMinutesElapsed() {
		// I get the elapsed seconds and divide it by 60 to get in minutes.
...
function rating() {
	/*
		...
		If player moves are equal/more than 20 and less than 35 I give two stars and
		If player moves are equal/more than 35, I give one star, the minimum.
	 */
